 ...
 * @UniqueEntity(
 *  fields={"title"},
 *  message="Une autre annonce pocède déja ce titre, merci de le modifier"
 * )
 */
class Ad
{
    ...
    public function getNotAvailableDays()
    {
        ...
        foreach($this->bookings as $booking)
        {
            //Calculer les jours qui se trouvent entre la date d'arrivée et de départ
               //range : retourne un tableau de timestamp
            $resultat = range(
            ...
            //Prend le tableau des timestamp ($resultat) et retourne un tableau de date 
