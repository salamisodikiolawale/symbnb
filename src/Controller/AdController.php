...
class AdController extends AbstractController
{
    ...
    /**
     * Permet de supprimer une annonce par sont User
     * @Route("/ads/{slug}/delete", name="ads_delete")
     * @Security("is_granted('ROLE_USER') and user == ad.getAuthor()", message="Vous n'avez pas le droit d'acceder a cette page")
     * 
     * @param Ad $ad
